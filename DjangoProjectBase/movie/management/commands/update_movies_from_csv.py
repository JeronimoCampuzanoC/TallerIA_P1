...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        csv_file = '/home/jerocrackh/Desktop/university/p1/Taller3P1/TallerIA_P1/aux_files/updated_movie_descriptions.csv'  # ← Puedes cambiar el nombre si es necesario
